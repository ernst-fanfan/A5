...
public class BST_Ernst_Fanfan<E extends Comparable<E>> extends AbstractTree_Ernst_Fanfan<E> {
    protected TreeNode<E> root;
    protected int size = 0;

    //Create a default binary search tree
    public BST_Ernst_Fanfan() {
    }

    //Create a binary search tree from an array of objects
    public BST_Ernst_Fanfan(E[] objects) {
    ...
    * Return false if the element is not in the tree. */
    public boolean delete(E e) {// Locate the node to be deleted and also locate its parent node
        TreeNode<E> parent = null;
        TreeNode<E> current = root;
        while (current != null) {
            if (e.compareTo(current.element) < 0) {
